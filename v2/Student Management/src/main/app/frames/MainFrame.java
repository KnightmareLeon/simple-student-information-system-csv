...
public class MainFrame extends JFrame{
    ...
    private SaveButton saveButton = new SaveButton(mTable);

    private AddDataButton addStdButton = new AddStudentButton(mTable);
    private AddDataButton addPrgButton = new AddProgramButton(mTable);
    private AddDataButton addClgButton = new AddCollegeButton(mTable);
    
    private DeleteDataButton delStdButton = new DeleteStudentButton(mTable);
    private DeleteDataButton delPrgButton = new DeleteProgramButton(mTable);
    private DeleteDataButton delClgButton = new DeleteCollegeButton(mTable);

    private EditDataButton editStdButton = new EditStudentButton(mTable);
    private EditDataButton editPrgButton = new EditProgramButton(mTable);
    private EditDataButton editClgButton = new EditCollegeButton(mTable);
