...
public class StudentInput extends DataInput{
    ...
    /**
     * Constructor specifically for adding a new student.
     * 
    ...
    /**
     * Constructor specifically for editing an existing student's data.
     * 
     * @param dFrame - this app's custom {@code JFrame} in which the components
     * will be displayed
     * @param mTable - this app's custom {@code JTable} that also includes 
     * the {@code DataMap}
    ...
    protected void setUpComponents(DataFrame dFrame, DataMap dMap, GridBagConstraints frameGBC){
        ...
        this.panelGBC.gridx = 1; this.panelGBC.gridy = 0; this.panelGBC.fill = GridBagConstraints.NONE; 
