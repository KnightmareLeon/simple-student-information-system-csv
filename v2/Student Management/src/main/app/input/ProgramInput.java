...
public class ProgramInput extends DataInput{
    ...
    /**
     * Constructor specifically for adding a new program.
     * 
    ...
    /**
     * Constructor specifically for editing an existing program's data.
     * 
    ...
    protected void setUpComponents(DataFrame dFrame, DataMap dMap, GridBagConstraints frameGBC){
        ...
        this.cCodeList = new AutoCompletingComboBox(dMap.getCollegeList());
        this.codeField.setPreferredSize(new Dimension(70, 20));
        this.cName.setText((dMap.getCollege((String)this.cCodeList.getSelectedItem())).getName());
        this.cCodeList.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent e) {
                cName.setText((dMap.getCollege((String)cCodeList.getSelectedItem())).getName());
            }
